...
def fit_one_epoch(model, train_loader, batch_transforms, optimizer, scheduler, amp=False):
    ...
    for images, targets in pbar:
        ...
        pbar.set_description(f"Training loss: {train_loss_value:.6}")
...
def main(args):
    ...
    for epoch in range(args.epochs):
        train_loss_value = fit_one_epoch(model, train_loader, batch_transforms, optimizer, scheduler, amp=args.amp)
